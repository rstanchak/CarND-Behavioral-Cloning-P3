...
from keras.layers import Flatten, Dropout, Dense, Lambda, Cropping2D, Convolution2D, GlobalAveragePooling2D
...
# STRIVING FOR SIMPLICITY: THE ALL CONVOLUTIONAL NET. Jost Tobias Springenberg, Alexey Dosovitskiy, Thomas Brox, Martin Riedmiller. ICLR 2015
...
model.add(Convolution2D(5,1,1,activation='relu'))
